...
Das neuronale Netzwerk besteht aus zwei verschiedene Schichtarten. Die Eingabe wird zuerst in den faltenden (im Englischen 'convolutional') Schichten bearbeitet. Der Teil des Netzwerkes ist besonders geeignet um bestimmte Merkmale eines Bildes zu extrahieren. Die erste konvolutionelle
\begin{figure}
	 \centering
